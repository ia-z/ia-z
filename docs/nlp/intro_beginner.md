...
- Google Search : Effectuez des recherches sur l'ensemble du Web et affichez des résultats de recherche pertinents.
- Google Gmail : Complétez automatiquement les phrases lorsque vous écrivez des e-mails
- Google Translate : Convertissez du texte et de l'audio d'une langue à l'autre.
- Amazon Alexa, Apple Siri, Google Assistant, Microsoft Cortana : donnez des commandes vocales et contrôlez vos appareils domestiques.
...
Avant de commencer ce cours, nous partons du principe que vous avez déjà quelques connaissances en Machine Learning et que vous avez déjà utilisé Python et des librairies telles que Numpy, pandas et matplotlib. De plus, une bonne connaissance du calcul différentiel, de l'algèbre linéaire, des probabilités et des statistiques est très fortement recommandé.